...
function update_perjalanan() {
    ...
    $update_data_perjalanan = "UPDATE perjalanan SET transportasi='$transportasi', dari_jalan='$dari_jalan', ke_jalan='$ke_jalan', pengeluaran='$pengeluaran', dok='$dok',tanggal='$tanggal' WHERE id ='$get_id'";
